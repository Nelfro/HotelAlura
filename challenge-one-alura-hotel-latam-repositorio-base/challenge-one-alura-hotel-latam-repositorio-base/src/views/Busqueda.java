		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas >= 0) {
					...
					int confirmar = JOptionPane.showConfirmDialog(null, "Desea borra la reserva");
					...
					int confirmaH = JOptionPane.showConfirmDialog(null, "Desea borra al huesped?");
...
//--------------RESERVAS CRUD------------------------
	...
	private void ActualizarReservas() {
		...
		//Para no editar por error los ids
...
//-----------------HUESPEDES CRUD-----------------
	...
	private void actualizarHuespedes() {
		...
		.ifPresentOrElse(filaHuespedes ->{
			...
			LocalDate fechaNacimiento = LocalDate.parse(modeloH.getValueAt(tbHuespedes.getSelectedRow(), 3).toString());
			...
			if(tbHuespedes.getSelectedColumn() ==6 || tbHuespedes.getSelectedColumn() ==0 ) {
				...
				JOptionPane.showMessageDialog(this, String.format("Regitro modificado con exito!"));
			}			
			
		}, ()-> JOptionPane.showInternalMessageDialog(this, "Por favor se amable"));
	}
